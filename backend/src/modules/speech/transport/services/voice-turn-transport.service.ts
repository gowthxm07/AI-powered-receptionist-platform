    ...
    try {
      ...
      return {
        ...
        metrics: {
          ...
          whisperLatencyMs: orchestratorResult.metrics.whisperLatencyMs || orchestratorResult.metrics.sttLatencyMs,
          conversationMs: orchestratorResult.metrics.conversationLatencyMs,
          databaseToolLatencyMs: orchestratorResult.metrics.databaseToolLatencyMs || 0,
          ollamaLatencyMs: orchestratorResult.metrics.ollamaLatencyMs || 0,
          responseOptimizationMs: orchestratorResult.metrics.responseOptimizationMs || 0,
          ttsMs: orchestratorResult.metrics.ttsLatencyMs,
          piperTtsLatencyMs: orchestratorResult.metrics.piperTtsLatencyMs || orchestratorResult.metrics.ttsLatencyMs,
          responseAudioPreparationMs: orchestratorResult.metrics.responseAudioPreparationMs || 0,
          totalBackendLatencyMs: totalPipelineMs,
          totalMs: totalPipelineMs,
          recordingDurationMs: metadata?.recordingDurationMs as number | undefined,
          audioBlobSizeBytes: metadata?.audioBlobSizeBytes as number | undefined,
          speechDetected: metadata?.speechDetected as boolean | undefined,
          trailingSilenceMs: metadata?.trailingSilenceMs as number | undefined,
          uploadDispatchMs: metadata?.uploadDispatchMs as number | undefined,
          autoStopTriggered: metadata?.autoStopTriggered as boolean | undefined,
          vadOverheadMs: metadata?.vadOverheadMs as number | undefined,
