...
import { Bot, User as UserIcon, Mail, Lock, Eye, EyeOff, ArrowRight, AlertCircle, Loader2, ShieldCheck, CheckCircle2 } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/2 translate-x-1/2 -translate-y-1/2 w-[550px] h-[550px] bg-indigo-600/15 rounded-full blur-[130px] pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/4 w-[450px] h-[450px] bg-blue-600/10 rounded-full blur-[130px] pointer-events-none" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 px-4">
        ...
        <p className="mt-2 text-center text-sm text-slate-400">
          Get started with your autonomous AI receptionist instance
        </p>
      </div>
              ...
              <div>
                ...
                <div className="relative rounded-xl shadow-sm">
                  ...
                  <select
                    ...
                    className="block w-full pl-10 pr-3 py-2.5 bg-slate-950/70 border border-slate-700/80 rounded-xl text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                  >
                    <option value="BUSINESS_OWNER">Business Owner (Full Business Management)</option>
                    <option value="ADMIN">System Administrator (Global Platform Access)</option>
                  </select>
                </div>
              </div>
